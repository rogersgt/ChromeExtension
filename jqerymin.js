...
function(a, b) {
        ...
        globalEval: function(a) {
            ...
            a = n.trim(a), a && (1 === a.indexOf("use strict") ?
                (b = l.createElement("script"), b.text = a,
                    l.head.appendChild(b).parentNode.removeChild(
                        b)) : c(a))
        },
    ...
    var t = function(a) {
                ...
                if (c.qsa && (!q || !q.test(a))) {
                    if (s = r = u, w = b, x = 1 !== k && a, 1 === k &&
                        ...
                        o = g(a), (r = b.getAttribute("id")) ? s =
                            r.replace(ba, "\\$&") : b.setAttribute(
                                "id", s), s = "[id='" + s + "'] ",
                            l = o.length;
                        while (l--) o[l] = s + ra(o[l]);
                        w = aa.test(a) && pa(b.parentNode) || b, x =
                            o.join(",")
                    }
                    if (x) try {
        ...
        function wa(a, b, c, d, e, f) {
            return d && !d[u] && (d = wa(d)), e && !e[u] && (e = wa(
                e, f)), ia(function(f, g, h, i) {
                var j, k, l, m = [],
                    n = [],
                    o = g.length,
                    p = f || ua(b || "*", h.nodeType ? [h] :
                        h, []),
                    q = !a || !f && b ? p : va(p, m, a, h,
                        i),
                    r = c ? e || (f ? a : o || d) ? [] : g :
                    q;
                if (c && c(q, r, h, i), d) {
            ...
            for (var b, c, e, f = a.length, g = d.relative[a[0].type],
                ...
                if (c = d.relative[a[i].type]) m = [sa(ta(m), c)];
                    ...
                    if (c = d.filter[a[i].type].apply(null, a[i].matches),
                        ...
                        return wa(i > 1 && ta(m), i > 1 && ra(a.slice(
                                0, i - 1).concat({
                                value: " " === a[i - 2]
                                    .type ? "*" : ""
                            })).replace(R, "$1"), c, e > i &&
                            xa(a.slice(i, e)), f > e && xa(a =
                                a.slice(e)), f > e && ra(a))
                    }
                    m.push(c)
                }
        ...
        ready: function(a) {
            (a === !0 ? --n.readyWait : n.isReady) || (n.isReady = !
                0, a !== !0 && --n.readyWait > 0 || (H.resolveWith(
                    l, [n]), n.fn.triggerHandler && (n(l).triggerHandler(
                    "ready"), n(l).off("ready"))))
        }
    });
    ...
    ! function() {
        ...
        c.setAttribute("type", "radio"), c.setAttribute("checked",
            ...
            b.innerHTML = "<textarea>x</textarea>", k.noCloneChecked = !!b.cloneNode(!
    ...
    n.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (r) {
                ...
                while (j--) h = Y.exec(b[j]) || [], o = q = h[1], p =
                    (h[2] || "").split(".").sort(), o && (l = n.event
                        .special[o] || {}, o = (e ? l.delegateType :
                            l.bindType) || o, l = n.event.special[o] || {},
                        k = n.extend({
                            type: o,
                            origType: q,
                            data: d,
        ...
        off: function(a, b, c) {
            ...
            if (a && a.preventDefault && a.handleObj) return d =
                a.handleObj, n(a.delegateTarget).off(d.namespace ?
    ...
    n.extend({
        clone: function(a, b, c) {
            ...
            if (!(k.noCloneChecked || 1 !== a.nodeType && 11 !==
                ...
                for (g = oa(h), f = oa(a), d = 0, e = f.length; e >
                    d; d++) pa(f[d], g[d]);
            if (b)
                if (c)
                    for (f = f || oa(a), g = g || oa(h), d = 0,
                        e = f.length; e > d; d++) na(f[d], g[d]);
                else na(a, h);
            return g = oa(h, "script"), g.length > 0 && ma(g, !
                i && oa(a, "script")), h
        },
        buildFragment: function(a, b, c, d) {
            for (var e, f, g, h, i, j, k = b.createDocumentFragment(),
                ...
                f = f || k.appendChild(b.createElement("div")),
                    ...
                    h = ia[g] || ia._default, f.innerHTML = h[1] +
                    e.replace(aa, "<$1></$2>") + h[2], j = h[0];
            ...
            while (e = l[m++])
                if ((!d || -1 === n.inArray(e, d)) && (i = n.contains(
                    e.ownerDocument, e), f = oa(k.appendChild(
                    e), "script"), i && ma(f), c)) {
                    j = 0;
                    while (e = f[j++]) fa.test(e.type || "") &&
                        c.push(e)
                }
            return k
        },
        ...
        remove: function(a, b) {
            for (var c, d = a ? n.filter(a, this) : this, e = 0; null !=
                ...
                oa(c)), c.parentNode && (b && n.contains(c.ownerDocument,
                    c) && ma(oa(c, "script")), c.parentNode
                .removeChild(c));
            return this
        },
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) 1 ===
                a.nodeType && (n.cleanData(oa(a, !1)), a.textContent =
                    "");
            return this
        },
        clone: function(a, b) {
        ...
        replaceWith: function() {
            ...
            return this.domManip(arguments, function(b) {
                    a = this.parentNode, n.cleanData(oa(
        ...
        domManip: function(a, b) {
            ...
            if (q || l > 1 && "string" == typeof p && !k.checkClone &&
                ea.test(p)) return this.each(function(c) {
                var d = m.eq(c);
    ...
    function ta(a) {
        ...
        return c || (c = sa(a, b), "none" !== c && c || (qa = (qa || n(
                ...
                )).appendTo(b.documentElement), b = qa[0].contentDocument,
                b.write(), b.close(), c = sa(a, b), qa.detach()),
            ra[a] = c), c
    }
    var ua = /^margin/,
    ...
    function xa(a, b, c) {
        ...
        return c = c || wa(a), c && (g = c.getPropertyValue(b) || c[b]),
            c && ("" !== g || n.contains(a.ownerDocument, a) || (g = n.style(
                a, b)), va.test(g) && ua.test(b) && (d = h.width, e =
    ...
    function ya(a, b) {
        ...
        if (f.style) {
            f.style.backgroundClip = "content-box", f.cloneNode(!0).style
                .backgroundClip = "", k.clearCloneStyle = "content-box" ===
                f.style.backgroundClip, e.style.cssText =
                ...
                reliableMarginRight: function() {
                    ...
                    return c.style.cssText = f.style.cssText =
                        ...
                        "0", f.style.width = "1px", d.appendChild(
                            ...
                            c, null).marginRight), d.removeChild(
                            e), f.removeChild(c), b
                }
            })
        }
    ...
    function Ia(a, b, c) {
        ...
        if (0 >= e || null == e) {
            if (e = xa(a, b, f), (0 > e || null == e) && (e = a.style[b]),
                va.test(e)) return e;
            d = g && (k.boxSizingReliable() || e === a.style[b]), e =
                parseFloat(e) || 0
        }
        return e + Ha(a, b, c || (g ? "border" : "content"), d, f) +
            "px"
    }
        ...
        for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++) d =
            a[g], d.style && (f[g] = L.get(d, "olddisplay"), c = d.style
                .display, b ? (f[g] || "none" !== c || (d.style.display =
                    ...
                    L.access(d, "olddisplay", ta(d.nodeName)))) : (e =
    ...
    n.extend({
        ...
        css: function(a, b, c, d) {
            var e, f, g, h = n.camelCase(b);
            return b = n.cssProps[h] || (n.cssProps[h] = Fa(a.style,
                    h)), g = n.cssHooks[b] || n.cssHooks[h], g &&
                "get" in g && (e = g.get(a, !0, c)), void 0 ===
                e && (e = xa(a, b, d)), "normal" === e && b in
                Da && (e = Da[b]), "" === c || c ? (f =
        ...
        n.cssHooks[b] = {
            get: function(a, c, d) {
                return c ? za.test(n.css(a, "display")) &&
                    0 === a.offsetWidth ? n.swap(a, Ca,
                        function() {
                            return Ia(a, b, d)
                        }) : Ia(a, b, d) : void 0
            },
            set: function(a, c, d) {
                var e = d && wa(a);
                return Ga(a, c, d ? Ha(a, b, d,
                    "border-box" === n.css(a,
                        "boxSizing", !1, e), e) : 0)
            }
        }
    }), n.cssHooks.marginRight = ya(k.reliableMarginRight, function(a,
        b) {
        return b ? n.swap(a, {
    ...
    n.Tween = Ka, Ka.prototype = {
        ...
        cur: function() {
            ...
            return a && a.get ? a.get(this) : Ka.propHooks._default
                .get(this)
        },
        run: function(a) {
            var b, c = Ka.propHooks[this.prop];
            return this.options.duration ? this.pos = b = n.easing[
                ...
                this.options.step && this.options.step.call(this.elem,
                    this.now, this), c && c.set ? c.set(this) : Ka.propHooks
            ...
            "*": [
                function(a, b) {
                    var c = this.createTween(a, b),
                        ...
                        g = (n.cssNumber[a] || "px" !== f && +d) && Oa.exec(
                            n.css(c.elem, a)),
                        h = 1,
                        i = 20;
                    if (g && g[3] !== f) {
    ...
    function Ua(a, b, c) {
        for (var d, e = (Ra[b] || []).concat(Ra["*"]), f = 0, g = e.length; g >
            f; f++)
    ...
    function Va(a, b, c) {
        ...
        c.queue || (h = n._queueHooks(a, "fx"), null == h.unqueued && (
            ...
            (c.overflow = [o.overflow, o.overflowX, o.overflowY], j = n
                .css(a, "display"), k = "none" === j ? L.get(a,
                    "olddisplay") || ta(a.nodeName) : j, "inline" === k &&
        ...
        if (n.isEmptyObject(m)) "inline" === ("none" === j ? ta(a.nodeName) :
            j) && (o.display = j);
        else {
            q ? "hidden" in q && (p = q.hidden) : q = L.access(a,
                    "fxshow", {}), f && (q.hidden = !p), p ? n(a).show() :
                l.done(function() {
                    n(a).hide()
                }), l.done(function() {
                    var b;
            ...
            for (d in m) g = Ua(p ? q[d] : 0, d, l), d in q || (q[d] =
    ...
    function Xa(a, b, c) {
        var d, e, f = 0,
            ...
            i = function() {
                if (e) return !1;
                for (var b = La || Sa(), c = Math.max(0, j.startTime +
        ...
        return n.map(k, Ua, j), n.isFunction(j.opts.start) && j.opts.start
    ...
    n.Animation = n.extend(Xa, {
            ...
            n.fn[b] = function(a, d, e) {
                return null == a || "boolean" == typeof a ? c.apply(
                    this, arguments) : this.animate(Ta(b, !0),
                    a, d, e)
            }
        }), n.each({
            slideDown: Ta("show"),
            ...
            var a, b = 0,
                c = n.timers;
            for (La = n.now(); b < c.length; b++) a = c[b], a() || c[b] !==
                a || c.splice(b--, 1);
    ...
    n.fn.extend({
            ...
            if (a && 3 !== f && 8 !== f && 2 !== f) return
                typeof a.getAttribute === U ? n.prop(a, b,
                    c) : (1 === f && n.isXMLDoc(a) || (b =
                        ...
                        (n.expr.match.bool.test(b) ? Za :
                            Ya)), void 0 === c ? d && "get" in
        ...
        $a[b] = function(a, b, d) {
            var e, f;
            return d || (f = $a[b], $a[b] = e, e = null != c(a,
                    b, d) ? b.toLowerCase() : null, $a[b] =
                f), e
        }
    });
    ...
    n.fn.extend({
        ...
        propHooks: {
            tabIndex: {
                get: function(a) {
                    return a.hasAttribute("tabindex") || _a.test(
    ...
    n.fn.extend({
        ...
        removeClass: function(a) {
            var b, c, d, e, f, g, h = 0 === arguments.length ||
                ...
                j = this.length;
            if (n.isFunction(a)) return this.each(function(b) {
                n(this).removeClass(a.call(this, b,
                    this.className))
            });
            if (h)
                for (b = (a || "").match(E) || []; j > i; i++)
            ...
            return "boolean" == typeof b && "string" === c ? b ?
                this.addClass(a) : this.removeClass(a) : this.each(
                    n.isFunction(a) ? function(c) {
                        n(this).toggleClass(a.call(this, c,
                            this.className, b), b)
                    } : function() {
                        if ("string" === c) {
                            var b, d = 0,
    ...
    n.extend({
        ...
        ajaxSetup: function(a, b) {
            return b ? sb(sb(a, n.ajaxSettings), b) : sb(n.ajaxSettings,
                a)
        },
        ajaxPrefilter: qb(lb),
        ajaxTransport: qb(mb),
        ajax: function(a, b) {
            ...
            if (o.promise(v).complete = p.add, v.success = v.done,
                v.error = v.fail, k.url = ((a || k.url || ob) +
                    "").replace(eb, "").replace(jb, pb[1] +
            ...
            i = n.event && k.global, i && 0 === n.active++ && n
                ...
                k.hasContent = !ib.test(k.type), d = k.url, k.hasContent ||
                (k.data && (d = k.url += (db.test(d) ? "&" :
                        "?") + k.data, delete k.data), k.cache ===
                    !1 && (k.url = fb.test(d) ? d.replace(fb,
                        "$1_=" + cb++) : d + (db.test(d) ?
                        "&" : "?") + "_=" + cb++)), k.ifModified &&
        ...
        unwrap: function() {
            return this.parent().each(function() {
                n.nodeName(this, "body") || n(this).replaceWith(
                    this.childNodes)
            }).end()
        }
    ...
    n.param = function(a, b) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                return this.name && !n(this).is(
                        ":disabled") && zb.test(this.nodeName) &&
                    !yb.test(a) && (this.checked || !T.test(
                        a))
            }).map(function(a, b) {
                var c = n(this).val();
    ...
    a.attachEvent && a.attachEvent("onunload", function() {
        ...
        }), k.cors = !!Eb && "withCredentials" in Eb, k.ajax = Eb = !!Eb, n
    ...
    n.ajaxSetup({
        ...
        var e, f, g, h = b.jsonp !== !1 && (Gb.test(b.url) ? "url" :
            "string" == typeof b.data && !(b.contentType || "")
            .indexOf("application/x-www-form-urlencoded") && Gb
            .test(b.data) && "data");
        return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback =
            n.isFunction(b.jsonpCallback) ? b.jsonpCallback() :
            b.jsonpCallback, h ? b[h] = b[h].replace(Gb, "$1" +
                e) : b.jsonp !== !1 && (b.url += (db.test(b.url) ?
    ...
    n.fn.load = function(a, b, c) {
        ...
        return h >= 0 && (d = n.trim(a.slice(h)), a = a.slice(0, h)), n
            ...
            typeof b && (e = "POST"), g.length > 0 && n.ajax({
                ...
                f = arguments, g.html(d ? n("<div>").append(n.parseHTML(
                    a)).find(d) : a)
    ...
    n.offset = {
            setOffset: function(a, b, c) {
                ...
                "static" === k && (a.style.position = "relative"), h =
                    ...
                    (f + i).indexOf("auto") > -1, j ? (d = l.position(),
                        ...
                        0, e = parseFloat(i) || 0), n.isFunction(b) &&
            ...
            n.cssHooks[b] = ya(k.pixelPosition, function(a, c) {
                return c ? (c = xa(a, b), va.test(c) ? n(a).position()[
                    b] + "px" : c) : void 0
            })
        }), n.each({
            Height: "height",
    ...
    return n.noConflict = function(b) {
        return a.$ === n && (a.$ = Lb), b && a.jQuery === n && (a.jQuery =
            Kb), n
